...
var LlmService = function () {
    ...
    var LlmService = _classThis = /** @class */ (function () {
        ...
        LlmService_1.prototype.chat = function (messages) {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                var _a, _b, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, this.client.chat.completions.create({
                                model: this.model,
                                messages: messages,
                                temperature: 0.2,
                            })];
                        case 1:
                            res = _d.sent();
                            return [2 /*return*/, (_c = (_b = (_a = res.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) !== null && _c !== void 0 ? _c : ''];
                    }
                });
            });
        };
